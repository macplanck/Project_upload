...
<<<<<<< HEAD
                                ...
                                if (instQKV.outValid):
                                    if (SMDCnt == (instQK.seqLen//32)-1):
                                        qkvSumReg = instSramSP['qkvSum'][QKVCnt]
                                        qkvMaxReg = instSramSP['qkvMax'][QKVCnt]

                                    qkvSumReg,qkvMaxReg,qkvSMValid = instQKVSM.one_operation(inSum = QKVRslt, theSum = qkvSumReg, theMax = qkvMaxReg, colMarker = VColCnt)
